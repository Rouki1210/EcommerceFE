      ...
      >
        ...
        >
          <div>
            ...
            <div style={{ color: "#9a8c7e", fontSize: 11, marginTop: 2 }}>
            ...
            >
              ...
              <div>
                ...
                <div
                  ...
                  style={{
                    border: `2px dashed ${dragging ? "#c8a96e" : "#e8e2db"}`,
                    borderRadius: 12,
                    cursor: "pointer",
                    transition: "all 0.2s",
                    background: dragging ? "rgba(200,169,110,0.04)" : "#faf8f5",
                    overflow: "hidden",
                ...
                >
                  {preview ? (
                    ...
                    <div style={{ textAlign: "center", padding: 16 }}>
                      ...
                      <div
                        style={{ color: "#b5a99b", fontSize: 10, marginTop: 3 }}
                      >
                        or drag & drop
                      </div>
                      <div
                        style={{ color: "#cbd5e1", fontSize: 9, marginTop: 2 }}
                      >
                        PNG · JPG · WEBP
                      </div>
                    </div>
                ...
                {preview && (
                  ...
                  >
                    <FiTrash2 size={10} style={{ marginRight: 4 }} /> Remove
                  </button>
                )}
              </div>
                      ...
                      <div
                        ...
                        style={{
                          ...
                          background: form.sizes.includes(size)
                            ? "#c8a96e"
                            : "#faf8f5",
                          color: form.sizes.includes(size) ? "#fff" : "#9a8c7e",
                          border: form.sizes.includes(size)
                            ? "1px solid #c8a96e"
                            : "1px solid #e8e2db",
                          boxShadow: form.sizes.includes(size)
                ...
                <div style={{ gridColumn: "1 / -1", marginTop: 8 }}>
                  ...
                  >
                    ...
                    <div>
                      ...
                      <div
                        style={{ color: "#9a8c7e", fontSize: 11, marginTop: 2 }}
                      >
              ...
              <div>
                ...
                >
                  <div>
                    ...
                    <div style={{ color: "#9a8c7e", fontSize: 11 }}>
                  ...
                  {form.sizeChart.rows.map((row, rowIdx) => (
                    <div
                      ...
                      style={{
                        display: "grid",
                        gridTemplateColumns: `repeat(${form.sizeChart.headers.length}, 1fr) 36px`,
                        borderBottom: "1px solid rgba(44,44,44,0.04)",
                        background: rowIdx % 2 === 0 ? "#fff" : "#faf8f5",
                      }}
                    >
                      {row.map((cell, colIdx) => (
                        <input
                          ...
                          value={cell}
                          onChange={(e) =>
                            updateSizeRow(rowIdx, colIdx, e.target.value)
                          }
                ...
                {form.sizeChart.rows.length > 0 && (
                  <div
                    style={{ marginTop: 10, color: "#9a8c7e", fontSize: 10 }}
                  >
