    ...
    return (
      ...
      `}</style>
            ...
            <div className="max-w-6xl mx-auto px-6 flex items-center justify-between h-16">
                ...
                {/* Nav links */}
                <div
                    className="hidden md:flex items-center gap-8 text-xs tracking-widest uppercase text-[#888]"
                    style={{
                ...
                >
                    {["New Arrivals", "Women", "Men", "Sale"].map((label) => (
                        <a key={label} href="#" className="hover:text-[#2c2c2c] transition-colors">{label}</a>
                    ))}
                </div>
                ...
                <div className="flex items-center gap-3">
                    ...
                    <div className="relative" ref={wrapperRef}>
                        ...
                        <div
                            ...
                            style={{
                                border: expanded ? "1px solid #d8d2cb" : "1px solid transparent",
                                ...
                                {suggestions.length > 0 ? (
                                            ...
                                            {suggestions.map((product, i) => (
                                                <li key={product.id}>
                                                    <button
                                                        ...
                                                        style={{
                                                            background: activeIdx === i ? "#f5f0eb" : "transparent",
                                                        }}
                                                    >
                                                        {/* Thumbnail */}
                                                        <img
                                    ...
                                    <div className="px-5 py-8 text-center">
                                        ...
                                        <p className="text-sm text-[#888]">
                                            No results for <span className="text-[#2c2c2c] font-medium">"{query}"</span>
                                        </p>
                                        <p className="text-xs text-[#bbb] mt-1">Try a different keyword</p>
                                    </div>
                                )}
                            </div>
                        )}
