...
export default function AdminLogin() {
  ...
  return (
    <div className="min-h-screen flex font-sans">
      {/* LEFT PANEL */}
      <div
        className="w-[48%] flex flex-col justify-between px-14 py-12 relative overflow-hidden"
        style={{
          background:
      ...
      >
        ...
        <div className="relative z-10 animate-[fadeSlideUp_0.5s_ease_both]">
          <div className="flex items-center gap-3">
            <div
              className="w-11 h-11 rounded-xl flex items-center justify-center text-xl font-black text-black shadow-lg shadow-yellow-400/40 animate-[float_3s_ease-in-out_infinite]"
              style={{
            ...
            <div>
              <div className="text-slate-900 text-[15px] font-extrabold tracking-wider">
                ADMIN PAGE
              </div>
              <div className="text-yellow-800 text-[9px] tracking-[2px]">
                ECOMMERCE
              </div>
            </div>
          </div>
        ...
        <div className="relative z-10 animate-[fadeSlideUp_0.6s_ease_0.1s_both]">
          ...
          <p className="text-yellow-900 text-[13px] leading-[1.8] max-w-xs m-0">
            Manage products, track orders, and grow your ecommerce business from
        ...
        <div className="relative z-10 flex gap-5 animate-[fadeSlideUp_0.6s_ease_0.2s_both]">
          {["🔒 Secure", "⚡ Fast", "📊 Analytics"].map((t, i) => (
            <div key={i} className="text-yellow-900 text-[11px] font-semibold">
              {t}
            </div>
          ))}
        </div>
      ...
      <div className="flex-1 flex flex-col justify-center items-center p-12 bg-white">
        <div className="w-full max-w-[400px] animate-[fadeSlideUp_0.5s_ease_0.15s_both]">
          <div className="mb-9">
            <div className="text-slate-400 text-[11px] tracking-[2px] mb-2 uppercase">
              Welcome Back
            </div>
          ...
          <div className="mb-4.5">
            <label className="text-slate-600 text-[11px] font-semibold block mb-1.5">
              Email address
            </label>
            <input
              type="email"
          ...
          <div className="mb-7">
            <div className="flex justify-between mb-1.5">
              <label className="text-slate-600 text-[11px] font-semibold">
                Password
              </label>
              <span className="text-yellow-500 text-[11px] cursor-pointer font-semibold hover:text-yellow-600">
                Forgot password?
              </span>
            </div>
          ...
          <button
            ...
            className={`w-full py-3.5 border-none rounded-xl cursor-pointer text-black font-extrabold text-sm flex items-center justify-center gap-2 transition-all ${
              loading
                ? "bg-yellow-200 cursor-not-allowed shadow-none"
                : "shadow-lg shadow-yellow-400/35 hover:shadow-yellow-400/50"
            }`}
            style={{
              background: loading
                ? "#fde68a"
          ...
          >
            {loading ? (
              <>
                <span className="animate-spin inline-block">⟳</span> Signing
                in...
              </>
            ) : (
              "Sign In →"
          ...
          <div className="bg-slate-50 rounded-xl px-4 py-3.5 border border-slate-200 flex gap-6 items-center">
            <div>
              <div className="text-slate-400 text-[9px] tracking-[1.5px] mb-1 uppercase">
                Email
              </div>
          ...
          <div className="text-center mt-7">
            <a
              href="/"
              className="text-slate-400 text-xs no-underline hover:text-slate-600 transition-colors"
            >
              ← Back to shop
            </a>
          </div>
