      ...
      >
        ...
        <div className="flex items-center justify-between px-6 py-5 border-b border-[#e8e2db]">
          <div>
            ...
            <h2 className="heading text-2xl text-[#2c2c2c]">
              Cart ({cartCount})
            </h2>
          </div>
          <button
            ...
            <div className="bg-white rounded-3xl overflow-hidden">
              {cart.map((item, i) => (
                <div key={item.cartItemId}>
                  ...
                  />
                  {i < cart.length - 1 && (
                    <div className="mx-4 h-px bg-[#f2f2f2]" />
                  )}
                </div>
              ))}
            </div>
          ...
          <div className="px-6 py-5 bg-white border-t border-[#e8e2db]">
            ...
            <div className="space-y-1.5 text-xs text-[#888] mb-4">
              ...
              <div className="flex justify-between">
                ...
                <span
                  className={
                    shipping === 0 ? "text-[#3a7a4a]" : "text-[#2c2c2c]"
                  }
                >
            ...
            <div className="flex justify-between items-baseline mb-4">
              ...
              <span className="heading text-xl text-[#2c2c2c]">
                ${total.toFixed(2)}
              </span>
            </div>
